...
def objective(trial: optuna.Trial) -> float:
    ...
    seed_everything()  # Reset seeds for reproducibility in each trial
...
if __name__ == "__main__":
    mlflow.set_experiment("seperable_tunet")
    ...
    with mlflow.start_run(run_name="seperable_tunet") as run:
